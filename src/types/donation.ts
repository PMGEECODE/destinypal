...
export type PaymentMethod = "mpesa" | "airtel_money" | "card" | "bank_transfer" | "paypal"
export type DonationFrequency = "one_time" | "monthly" | "quarterly" | "annually"
export type PaymentStep = "details" | "payment" | "processing" | "completed" | "failed"
...
export const DONATION_FREQUENCIES: { value: DonationFrequency; label: string }[] = [
