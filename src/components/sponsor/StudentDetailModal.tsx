...
export function StudentDetailModal({
  ...
  console.log("[v0] Rendering StudentDetailModal with student:", student);
  ...
  console.log("[v0] Student name:", fullName);
  console.log("[v0] Student photo URL:", photoUrl);
  console.log("[v0] Student background:", student.background_story);
  console.log("[v0] Student family:", student.family_situation);
  console.log("[v0] Student academics:", student.academic_performance);
        ...
        <div className="p-6 space-y-6">
          <div className="flex flex-col md:flex-row gap-6">
            <div className="flex-shrink-0">
              <div className="w-48 h-48 rounded-lg overflow-hidden bg-gradient-to-br from-blue-400 to-blue-600 shadow-lg relative">
                {photoUrl ? (
                  <img
                    ...
                    onError={(e) => {
                      console.log("[v0] Image load error for:", photoUrl);
                ...
                <div
                  className={`fallback-avatar absolute inset-0 w-full h-full flex flex-col items-center justify-center ${
                    photoUrl ? "hidden" : ""
                  }`}
                >
            ...
            <div className="flex-1 space-y-4">
              <div>
                ...
                <div className="flex items-center gap-2 text-blue-600 font-medium">
                  ...
                  {student.institution?.is_verified && (
            ...
            <div className="bg-blue-50 rounded-lg p-5">
              ...
              <p className="text-gray-700 leading-relaxed">
                {student.background_story ||
                  "No background story provided yet."}
              </p>
            </div>
            ...
            {student.payment_accounts && student.payment_accounts.length > 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="font-medium text-gray-800">
                          {safeString(account.account_name, "N/A")}
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-800">
                          {safeString(account.bank_name, "N/A")}
                        </p>
                      </div>
              ...
              <div className="bg-gray-50 rounded-lg p-8 text-center">
                ...
                <p className="text-gray-500">
                  No payment account information available
                </p>
              </div>
            )}
          </div>
