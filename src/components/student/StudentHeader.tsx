...
import { Bell, ChevronDown, LogOut, User, Settings, GraduationCap } from "lucide-react"
...
export function StudentHeader({ studentEmail, studentName, onLogout, onNavigate }: StudentHeaderProps) {
          ...
          <div ref={profileRef} className="relative">
            ...
            >
              ...
              <div className="hidden md:block text-left">
                ...
                <p className="text-xs text-gray-500 truncate max-w-[120px]">{studentEmail}</p>
              </div>
              <ChevronDown
