...
// import { AboutUs, Contact, TermsOfService, PrivacyPolicy, LandingPage } from "../pages"
...
// export const AuthRouter: React.FC<AuthRouterProps> = ({ onAuthenticated, initialView = "landing" }) => {
//   const { user, isLoading, twoFactorRequired, twoFactorMethod } = useAuth()
//   const [currentView, setCurrentView] = useState<AuthView>(initialView)
//   const [pendingEmail, setPendingEmail] = useState<string>("")
//   const [pendingPhone] = useState<string>("")
//   const [registeredUserType, setRegisteredUserType] = useState<UserRole | null>(null)
...
//     if (url.pathname.includes("/auth/callback") || hashParams.get("access_token")) {
...
//     const userType = (user.user_metadata?.user_type as UserRole) || user.role || "sponsor"
...
//       case "reset-password":
//         return <ResetPassword onSuccess={() => setCurrentView("login")} onBack={() => setCurrentView("login")} />
...
//             onSuccess={() => handleRegistrationComplete("sponsor", pendingEmail)}
...
//           <InstitutionRegister
//             onBack={() => setCurrentView("register-select")}
//             onSuccess={() => handleRegistrationComplete("institution", pendingEmail)}
//             onLogin={() => setCurrentView("login")}
//           />
//         )
...
//             onSuccess={() => handleRegistrationComplete("student", pendingEmail)}
//             onLogin={() => setCurrentView("login")}
//           />
//         )
...
export const AuthRouter: React.FC<AuthRouterProps> = ({ onAuthenticated, initialView = "landing" }) => {
  ...
  const [registeredUserType, setRegisteredUserType] = React.useState<UserRole | null>(null)
